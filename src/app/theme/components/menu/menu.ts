...
export const verticalMenuItemsClient = [
  new Menu(1, "Dashboard", "/dash", null, "dashboard", null, false, 0),
  new Menu(2, "Users", "/users", null, "supervisor_account", null, false, 0),
  new Menu(3, "Voitures", "/mesvoitures", null, "store", null, true, 0),
  new Menu(
    4,
  ...
  new Menu(5, "ajout Voiture", "/ajoutvoiture", null, "add", null, false, 3),
  new Menu(
    6,
    "Mes evenements",
    "/myevents",
  ...
  new Menu(8, "ajoutevent", "/ajoutevent", null, "add", null, false, 6)
];
export const verticalMenuItemsResp = [
  new Menu(1, "Dashboard", "/dash", null, "dashboard", null, false, 0),
  new Menu(2, "Users", "/users", null, "supervisor_account", null, false, 0),
  new Menu(3, "Voitures", "/voitures", null, "store", null, true, 0),
  new Menu(4, "liste des Voitures", "/voitures", null, "store", null, false, 3),
  new Menu(
    5,
    "List de mes Voitures",
    "/mesvoitures",
  ...
  new Menu(6, "ajout Voiture", "/ajoutvoiture", null, "add", null, false, 3),
  new Menu(7, "evenements", "/events", null, "location_city", null, true, 0),
  new Menu(8, "evenements", "/events", null, "location_city", null, false, 7),
  new Menu(9, "mes evenements", "/myevents", null, "add", null, false, 7),
  new Menu(10, "ajoutevent", "/ajoutevent", null, "add", null, false, 7),
  new Menu(
    11,
    "Pieces de rechanges",
    "/piecesrechanges",
